...
import { Send, CheckCircle, User, MessageCircle, Building, MapPin, Briefcase, Phone } from 'lucide-react';
import { useNavigate, useLocation } from 'react-router-dom';
import { toast } from 'react-toastify';
import { useUser } from '../../context/UserContext';
import { useTranslation } from 'react-i18next';
import { API_BASE_URL } from '../../config';
import AbstractBot from '../../assets/abstract-bot.svg'; // Add an abstract animated SVG avatar to your assets folder
import { useSpring, animated as a } from '@react-spring/web'; // For organic blob background
import './EmployerChatRegistration.css'; // Use for font and custom styles
import Logo from '../../assets/logo.svg'; // Place your logo SVG in assets or use a text placeholder
...
// --- Main Component ---
const EmployerChatRegistration = () => {
  ...
  // 1. Move the language question to the beginning of the chatQuestions array
  const chatQuestions = [
    {
      id: 'languages',
      type: 'question',
      text: "Which languages do you prefer to communicate in? You can select multiple:",
      field: 'languages',
    ...
    },
    {
      id: 'name',
      type: 'question',
      text: "Great! Let's start with your personal details. What's your full name?",
      field: 'name',
    ...
    },
    {
      id: 'complete',
      type: 'system',
      text: "🎉 Excellent! I have all the information I need. Let me create your employer profile now...",
      field: null
    }
  ];
  ...
  // 1. Set font globally for this component
  // 2. Set font globally for this component
  ...
  // Enhanced: processUserResponse with empathetic reaction step
  const processUserResponse = async (response) => {
    ...
    if (nextQuestionIndex < chatQuestions.length && nextQuestionIndex !== currentQuestion) {
      ...
      // Registration complete: POST to backend using the same robust logic as EmployerRegistration.jsx
      setIsSubmitting(true);
      try {
        
        // Ensure phone number is properly formatted (remove spaces and ensure it starts with 6-9)
        let phoneNumber = userResponses.phone;
        ...
        const registrationData = {
          ...
          phone: phoneNumber,
          email: userResponses.email || 'employer@example.com',
          company: {
            name: userResponses.businessName || 'Business Name',
            type: userResponses.businessType || 'Private Limited',
            industry: userResponses.industry || 'Other'
          },
          location: {
          ...
          businessDescription: userResponses.businessDescription || 'Business description',
          ...
          documents: [],
          preferredLanguages: userResponses.languages || ['Hindi'],
          rating: {
            average: 0,
            count: 0
          },
        ...
        // Generate a JWT token for the newly registered employer
        ...
        // Generate JWT token using the backend endpoint
        ...
        // Store employer data and token in localStorage
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#f5f6fa] px-4" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      {/* 5. Slide-in success message (Framer Motion) */}
      {showSuccessMsg && (
        <motion.div
...
export default EmployerChatRegistration;
