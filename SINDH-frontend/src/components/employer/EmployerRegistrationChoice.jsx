...
import { MessageCircle, FileText, Sparkles, Clock, Users, CheckCircle, Building } from 'lucide-react';
import { useTranslation } from 'react-i18next';

const EmployerRegistrationChoice = () => {
  ...
  const handleChatRegistration = () => {
    navigate('/employer/chat-register', { state: { phoneNumber } });
  };

  const handleFormRegistration = () => {
    navigate('/employer/form-register', { state: { phoneNumber } });
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-4">
            Welcome to SINDH Employers! 🏢
          </h1>
          <p className="text-xl text-gray-600 mb-2">
            Let's create your employer profile
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">
                Like chatting on WhatsApp! Quick, easy, and conversational
              </p>
            </div>
            ...
            <div className="bg-blue-50 p-4 rounded-xl mb-6">
              <div className="flex items-center text-blue-700 mb-2">
                ...
                <span className="text-sm font-medium">Estimated time: 4-6 minutes</span>
              </div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full px-6 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-200"
            >
          ...
          <motion.div
            ...
            className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 border-2 border-indigo-100 hover:border-indigo-300"
          >
            <div className="text-center mb-6">
            ...
            <div className="bg-indigo-50 p-4 rounded-xl mb-6">
              <div className="flex items-center text-indigo-700 mb-2">
                <Clock className="w-4 h-4 mr-2" />
                <span className="text-sm font-medium">Estimated time: 6-10 minutes</span>
              </div>
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="w-full px-6 py-4 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-200"
            >
        ...
        >
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-200">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">
              💡 Both options collect the same employer information
            </h3>
            <div className="grid md:grid-cols-3 gap-4 text-sm text-gray-600">
              <div>
                <span className="font-medium">👤 Personal Details</span>
                <br />Name, contact info, verification
              </div>
              <div>
                <span className="font-medium">🏢 Business Information</span>
                <br />Company details and industry
              </div>
              <div>
                <span className="font-medium">📍 Location & Preferences</span>
                <br />Business location and requirements
              </div>
            </div>
          </div>
        </motion.div>
...
export default EmployerRegistrationChoice;
