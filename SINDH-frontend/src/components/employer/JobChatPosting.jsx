...
const JobChatPosting = () => {
  ...
  const ensureEmployerProfile = async () => {
    try {
      ...
      const checkResponse = await fetch(`${API_BASE_URL}/api/employers/${user.id}`, {
        method: 'GET',
        headers: {
      ...
      const createResponse = await fetch(`${API_BASE_URL}/api/employers/register`, {
        method: 'POST',
        headers: {
  ...
  const logJobInitiation = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/jobs/initiate-creation`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
