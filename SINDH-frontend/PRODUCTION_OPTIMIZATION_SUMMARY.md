...
- **API Base**: https://sindh-backend.onrender.com/api
- **Health Check**: https://sindh-backend.onrender.com/api/health
- **Jobs Endpoint**: https://sindh-backend.onrender.com/api/jobs
- **Applications**: https://sindh-backend.onrender.com/api/applications
